const groups = [
  ...
  {
    name: "Support",
    description: "Support inbox visibility, ticket review, and resolution actions.",
    items: ["support:read", "support:write"],
  },
  {
    name: "Audit",
...
const templates = {
  ...
  "Support Manager": ["admin:access", "support:read", "support:write"],
